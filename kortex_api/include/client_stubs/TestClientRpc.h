...
public:
  ...
  void SetMockValidationStruct(const validateStruct& validatestruct, uint32_t deviceId = 0,
                               const RouterClientSendOptions& options = { false, 0, 3000 });
  void SetMockValidationStruct_callback(const validateStruct& validatestruct,
                                        std::function<void(const Error&)> callback, uint32_t deviceId = 0);
  std::future<void> SetMockValidationStruct_async(const validateStruct& validatestruct, uint32_t deviceId = 0,
                                                  const RouterClientSendOptions& options = { false, 0, 3000 });

  RcvStruct TestParamAndReturn(const SendStruct& sendstruct, uint32_t deviceId = 0,
                               const RouterClientSendOptions& options = { false, 0, 3000 });
  void TestParamAndReturn_callback(const SendStruct& sendstruct,
                                   std::function<void(const Error&, const RcvStruct&)> callback, uint32_t deviceId = 0);
  std::future<RcvStruct> TestParamAndReturn_async(const SendStruct& sendstruct, uint32_t deviceId = 0,
                                                  const RouterClientSendOptions& options = { false, 0, 3000 });

  void TestParamOnly(const SendStruct& sendstruct, uint32_t deviceId = 0,
                     const RouterClientSendOptions& options = { false, 0, 3000 });
  void TestParamOnly_callback(const SendStruct& sendstruct, std::function<void(const Error&)> callback,
                              uint32_t deviceId = 0);
  std::future<void> TestParamOnly_async(const SendStruct& sendstruct, uint32_t deviceId = 0,
                                        const RouterClientSendOptions& options = { false, 0, 3000 });
  ...
  std::future<RcvStruct> TestReturnOnly_async(uint32_t deviceId = 0,
                                              const RouterClientSendOptions& options = { false, 0, 3000 });
  ...
  std::future<void> TestTimeout_async(uint32_t deviceId = 0,
                                      const RouterClientSendOptions& options = { false, 0, 3000 });

  Kinova::Api::Common::NotificationHandle
  OnNotificationTestNotif(std::function<void(TestNotification)> callback, const NotifOption& notifoption,
                          uint32_t deviceId = 0, const RouterClientSendOptions& options = { false, 0, 3000 });

  void TestNotifUnsubscribe(const Kinova::Api::Common::NotificationHandle& notificationhandle, uint32_t deviceId = 0,
                            const RouterClientSendOptions& options = { false, 0, 3000 });

  void TestAsync(const timeToResponse& timetoresponse, uint32_t deviceId = 0,
                 const RouterClientSendOptions& options = { false, 0, 3000 });
  void TestAsync_callback(const timeToResponse& timetoresponse, std::function<void(const Error&)> callback,
                          uint32_t deviceId = 0);
  std::future<void> TestAsync_async(const timeToResponse& timetoresponse, uint32_t deviceId = 0,
                                    const RouterClientSendOptions& options = { false, 0, 3000 });
  ...
  std::future<void> TestConcurrence_async(uint32_t deviceId = 0,
                                          const RouterClientSendOptions& options = { false, 0, 3000 });
  ...
  std::future<void> TestTriggerNotif_async(uint32_t deviceId = 0,
                                           const RouterClientSendOptions& options = { false, 0, 3000 });
  ...
  std::future<void> TestNotImplemented_async(uint32_t deviceId = 0,
                                             const RouterClientSendOptions& options = { false, 0, 3000 });

  TestError ServerError(const TestError& testerror, uint32_t deviceId = 0,
                        const RouterClientSendOptions& options = { false, 0, 3000 });
  void ServerError_callback(const TestError& testerror, std::function<void(const Error&, const TestError&)> callback,
                            uint32_t deviceId = 0);
  std::future<TestError> ServerError_async(const TestError& testerror, uint32_t deviceId = 0,
                                           const RouterClientSendOptions& options = { false, 0, 3000 });
  ...
  Kinova::Api::Common::NotificationHandle
  OnNotificationSomethingChangeTopic(std::function<void(SomethingChanged)> callback,
  ...
  std::future<void> TriggerSomethingChangeTopic_async(uint32_t deviceId = 0,
                                                      const RouterClientSendOptions& options = { false, 0, 3000 });
  ...
  std::future<void> Wait_async(const Delay& delay, uint32_t deviceId = 0,
                               const RouterClientSendOptions& options = { false, 0, 3000 });

  void Throw(const Kinova::Api::Error& error, uint32_t deviceId = 0,
             const RouterClientSendOptions& options = { false, 0, 3000 });
  void Throw_callback(const Kinova::Api::Error& error, std::function<void(const Error&)> callback,
                      uint32_t deviceId = 0);
  std::future<void> Throw_async(const Kinova::Api::Error& error, uint32_t deviceId = 0,
                                const RouterClientSendOptions& options = { false, 0, 3000 });
  ...
  std::future<void> NotImplemented_async(uint32_t deviceId = 0,
                                         const RouterClientSendOptions& options = { false, 0, 3000 });
  ...
  DEPRECATED std::future<void> Deprecated_async(uint32_t deviceId = 0,
                                                const RouterClientSendOptions& options = { false, 0, 3000 });

  DEPRECATED_MSG("Purposely deprecated for test")
  void DeprecatedWithMessage(uint32_t deviceId = 0, const RouterClientSendOptions& options = { false, 0, 3000 });
  DEPRECATED_MSG("Purposely deprecated for test")
  void DeprecatedWithMessage_callback(std::function<void(const Error&)> callback, uint32_t deviceId = 0);
  DEPRECATED_MSG("Purposely deprecated for test")
  std::future<void> DeprecatedWithMessage_async(uint32_t deviceId = 0,
                                                const RouterClientSendOptions& options = { false, 0, 3000 });
