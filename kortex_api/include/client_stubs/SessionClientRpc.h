...
public:
  ...
  void CreateSession(const CreateSessionInfo& createsessioninfo, uint32_t deviceId = 0,
                     const RouterClientSendOptions& options = { false, 0, 3000 });
  void CreateSession_callback(const CreateSessionInfo& createsessioninfo, std::function<void(const Error&)> callback,
                              uint32_t deviceId = 0);
  std::future<void> CreateSession_async(const CreateSessionInfo& createsessioninfo, uint32_t deviceId = 0,
                                        const RouterClientSendOptions& options = { false, 0, 3000 });
  ...
  std::future<void> CloseSession_async(uint32_t deviceId = 0,
                                       const RouterClientSendOptions& options = { false, 0, 3000 });
  ...
  std::future<ConnectionList> GetConnections_async(uint32_t deviceId = 0,
                                                   const RouterClientSendOptions& options = { false, 0, 3000 });
