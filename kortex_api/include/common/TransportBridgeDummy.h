...
class TransportBridgeDummy
{
  ...
  public:
    ...
    {
      m_transportBridgeDummy->m_onMessageCallbackServer(m_transportBridgeDummy->m_connectionHandle, (uint8_t*)txBuffer,
                                                        (int)txSize);
    }
    ...
    virtual char* getTxBuffer() override
    {
      return m_transportBridgeDummy->m_bufferClientToServer;
    }

    virtual size_t getMaxTxBufferSize() override
    {
      return m_transportBridgeDummy->m_maxBufferSizeClientToServer;
    }
  };
...
public:
  ...
  ITransportServer* getServerTransport()
  {
    return m_server;
  }

  ITransportClient* getClientTransport()
  {
    return m_client;
  }
};
