...
#include "kortex2_gripper_driver/visibility_control.h"
...
{
class KortexGripperInterfaceHardware : public hardware_interface::BaseInterface<hardware_interface::SystemInterface>
{
public:
  KortexGripperInterfaceHardware();

  RCLCPP_SHARED_PTR_DEFINITIONS(KortexGripperInterfaceHardware);
