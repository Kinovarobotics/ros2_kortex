...
class ExampleWaypointActionClient:
    ...
    def example_cartesian_waypoint_action(self):
        ...
        client = actionlib.SimpleActionClient(
            "/"
            + self.robot_name
            + "/cartesian_trajectory_controller/follow_cartesian_trajectory",
        ...
        if config.output.model == ModelId.MODEL_ID_L31:
            ...
            goal.trajectory.append(
                self.FillCartesianWaypoint(
                    0.7, 0.0, 0.5, math.radians(90), 0, math.radians(90), 0
                )
            )
            goal.trajectory.append(
                self.FillCartesianWaypoint(
                    0.7, 0.0, 0.33, math.radians(90), 0, math.radians(90), 0.1
                )
            )
            goal.trajectory.append(
                self.FillCartesianWaypoint(
                    0.7, 0.48, 0.33, math.radians(90), 0, math.radians(90), 0.1
                )
            )
            goal.trajectory.append(
                self.FillCartesianWaypoint(
                    0.61, 0.22, 0.4, math.radians(90), 0, math.radians(90), 0.1
                )
            )
            goal.trajectory.append(
                self.FillCartesianWaypoint(
            ...
            goal.trajectory.append(
                self.FillCartesianWaypoint(
                    0.63, -0.22, 0.45, math.radians(90), 0, math.radians(90), 0.1
                )
            )
            goal.trajectory.append(
                self.FillCartesianWaypoint(
                    0.65, 0.05, 0.45, math.radians(90), 0, math.radians(90), 0
                )
            )
