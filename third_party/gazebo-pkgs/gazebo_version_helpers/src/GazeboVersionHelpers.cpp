...
///////////////////////////////////////////////////////////////////////////////
gazebo::physics::PhysicsEnginePtr gazebo::GetPhysics(const gazebo::physics::WorldPtr& world)
{
#if GAZEBO_MAJOR_VERSION >= 8
...
///////////////////////////////////////////////////////////////////////////////
gazebo::physics::EntityPtr gazebo::GetEntityByName(const gazebo::physics::WorldPtr& world, const std::string& name)
{
#if GAZEBO_MAJOR_VERSION >= 8
...
///////////////////////////////////////////////////////////////////////////////
gazebo::physics::ModelPtr gazebo::GetModelByName(const gazebo::physics::WorldPtr& world, const std::string& name)
{
#if GAZEBO_MAJOR_VERSION >= 8
...
///////////////////////////////////////////////////////////////////////////////
gazebo::physics::Model_V gazebo::GetModels(const gazebo::physics::WorldPtr& world)
{
#if GAZEBO_MAJOR_VERSION >= 8
  return world->Models();
#else
