...
int ToRosData(Kinova::Api::ControlConfig::ControlConfigurationNotification input,
              kortex_driver::ControlConfigurationNotification& output);
int ToRosData(Kinova::Api::ControlConfig::CartesianReferenceFrameInfo input,
              kortex_driver::CartesianReferenceFrameInfo& output);
...
int ToRosData(Kinova::Api::ControlConfig::JointAccelerationSoftLimits input,
              kortex_driver::JointAccelerationSoftLimits& output);
...
int ToRosData(Kinova::Api::ControlConfig::ControlModeInformation input,
              kortex_driver::ControlConfig_ControlModeInformation& output);
int ToRosData(Kinova::Api::ControlConfig::ControlModeNotification input,
              kortex_driver::ControlConfig_ControlModeNotification& output);
