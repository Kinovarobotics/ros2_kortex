...
int ToProtoData(kortex_driver::MappingInfoNotificationList input,
                Kinova::Api::Base::MappingInfoNotificationList* output);
int ToProtoData(kortex_driver::ControlModeNotificationList input,
                Kinova::Api::Base::ControlModeNotificationList* output);
...
int ToProtoData(kortex_driver::ControllerConfigurationMode input,
...
int ToProtoData(kortex_driver::ControllerConfigurationList input,
