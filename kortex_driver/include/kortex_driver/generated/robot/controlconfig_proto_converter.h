...
int ToProtoData(kortex_driver::ControlConfigurationNotification input,
                Kinova::Api::ControlConfig::ControlConfigurationNotification* output);
int ToProtoData(kortex_driver::CartesianReferenceFrameInfo input,
...
int ToProtoData(kortex_driver::JointAccelerationSoftLimits input,
...
int ToProtoData(kortex_driver::ControlConfig_ControlModeInformation input,
                Kinova::Api::ControlConfig::ControlModeInformation* output);
int ToProtoData(kortex_driver::ControlConfig_ControlModeNotification input,
                Kinova::Api::ControlConfig::ControlModeNotification* output);
