...
int ToProtoData(kortex_driver::CompleteProductConfiguration input,
                Kinova::Api::ProductConfiguration::CompleteProductConfiguration* output);
int ToProtoData(kortex_driver::ProductConfigurationEndEffectorType input,
                Kinova::Api::ProductConfiguration::ProductConfigurationEndEffectorType* output);
