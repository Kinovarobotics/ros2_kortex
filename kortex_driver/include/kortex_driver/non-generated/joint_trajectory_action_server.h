...
struct AngularTrajectorySoftLimits
{
  ...
  AngularTrajectorySoftLimits(const Kinova::Api::ControlConfig::JointSpeedSoftLimits& vel,
  ...
  inline bool empty() const
  {
    return google::protobuf::util::MessageDifferencer::Equals(
               m_vel, Kinova::Api::ControlConfig::JointSpeedSoftLimits::default_instance()) &&
           google::protobuf::util::MessageDifferencer::Equals(
               m_acc, Kinova::Api::ControlConfig::JointAccelerationSoftLimits::default_instance());
  }
};
...
public:
  ...
  JointTrajectoryActionServer(const std::string& server_name, ros::NodeHandle& nh, Kinova::Api::Base::BaseClient* base,
                              Kinova::Api::BaseCyclic::BaseCyclicClient* base_cyclic,
                              Kinova::Api::ControlConfig::ControlConfigClient* control_config,
                              bool use_hard_limits = false);
  ~JointTrajectoryActionServer();

  ActionServerState getState()
  {
...
private:
  ...
  void
  goal_received_callback(actionlib::ActionServer<control_msgs::FollowJointTrajectoryAction>::GoalHandle new_goal_handle);
  void
  preempt_received_callback(actionlib::ActionServer<control_msgs::FollowJointTrajectoryAction>::GoalHandle goal_handle);
