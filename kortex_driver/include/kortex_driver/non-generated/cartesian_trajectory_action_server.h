...
public:
  ...
  CartesianTrajectoryActionServer(const std::string& server_name, ros::NodeHandle& nh,
...
private:
  ...
  // Private methods
  bool
  is_goal_acceptable(actionlib::ActionServer<kortex_driver::FollowCartesianTrajectoryAction>::GoalHandle goal_handle);
