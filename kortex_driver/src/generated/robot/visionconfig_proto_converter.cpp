...
int ToProtoData(kortex_driver::IntrinsicProfileIdentifier input,
                Kinova::Api::VisionConfig::IntrinsicProfileIdentifier* output)
{
  output->set_sensor((Kinova::Api::VisionConfig::Sensor)input.sensor);
  output->set_resolution((Kinova::Api::VisionConfig::Resolution)input.resolution);
...
int ToProtoData(kortex_driver::VisionConfig_RotationMatrixRow input,
                Kinova::Api::VisionConfig::RotationMatrixRow* output)
{
