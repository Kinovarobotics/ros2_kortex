...
int ToProtoData(kortex_driver::EthernetDeviceIdentification input,
                Kinova::Api::InterconnectConfig::EthernetDeviceIdentification* output)
{
  output->set_device((Kinova::Api::InterconnectConfig::EthernetDevice)input.device);

  return 0;
}
int ToProtoData(kortex_driver::EthernetConfiguration input,
...
int ToProtoData(kortex_driver::InterconnectConfig_GPIOConfiguration input,
...
int ToProtoData(kortex_driver::I2CDeviceIdentification input,
                Kinova::Api::InterconnectConfig::I2CDeviceIdentification* output)
{
...
int ToProtoData(kortex_driver::I2CReadRegisterParameter input,
                Kinova::Api::InterconnectConfig::I2CReadRegisterParameter* output)
{
  output->set_device((Kinova::Api::InterconnectConfig::I2CDevice)input.device);
  output->set_device_address(input.device_address);
  output->set_register_address(input.register_address);
  output->set_register_address_size(
      (Kinova::Api::InterconnectConfig::I2CRegisterAddressSize)input.register_address_size);
  output->set_size(input.size);
  output->set_timeout(input.timeout);
...
int ToProtoData(kortex_driver::I2CWriteRegisterParameter input,
                Kinova::Api::InterconnectConfig::I2CWriteRegisterParameter* output)
{
  output->set_device((Kinova::Api::InterconnectConfig::I2CDevice)input.device);
  output->set_device_address(input.device_address);
  output->set_register_address(input.register_address);
