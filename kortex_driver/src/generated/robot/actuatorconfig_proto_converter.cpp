...
int ToProtoData(kortex_driver::ActuatorConfig_ControlModeInformation input,
...
int ToProtoData(kortex_driver::EncoderDerivativeParameters input,
                Kinova::Api::ActuatorConfig::EncoderDerivativeParameters* output)
{
...
int ToProtoData(kortex_driver::CoggingFeedforwardModeInformation input,
                Kinova::Api::ActuatorConfig::CoggingFeedforwardModeInformation* output)
{
  output->set_cogging_feedforward_mode(
      (Kinova::Api::ActuatorConfig::CoggingFeedforwardMode)input.cogging_feedforward_mode);
