...
int ToProtoData(kortex_driver::Action input, Kinova::Api::Base::Action* output)
{
  ...
  {
    output->set_toggle_admittance_mode(
        (Kinova::Api::Base::AdmittanceMode)input.oneof_action_parameters.toggle_admittance_mode[0]);
  }
  ...
  {
    output->set_navigate_joints(
        (Kinova::Api::Base::JointNavigationDirection)input.oneof_action_parameters.navigate_joints[0]);
  }
  if (input.oneof_action_parameters.navigate_mappings.size() > 0)
  {
    output->set_navigate_mappings(
        (Kinova::Api::Base::NavigationDirection)input.oneof_action_parameters.navigate_mappings[0]);
  }
  ...
  {
    ToProtoData(input.oneof_action_parameters.play_pre_computed_trajectory[0],
                output->mutable_play_pre_computed_trajectory());
  }
...
int ToProtoData(kortex_driver::CommunicationInterfaceConfiguration input,
...
int ToProtoData(kortex_driver::ConfigurationChangeNotification input,
                Kinova::Api::Base::ConfigurationChangeNotification* output)
{
...
int ToProtoData(kortex_driver::ConfigurationChangeNotificationList input,
                Kinova::Api::Base::ConfigurationChangeNotificationList* output)
{
...
int ToProtoData(kortex_driver::OperatingModeNotificationList input,
                Kinova::Api::Base::OperatingModeNotificationList* output)
{
  output->clear_notifications();
  for (int i = 0; i < input.notifications.size(); i++)
  {
...
int ToProtoData(kortex_driver::ServoingModeNotificationList input,
                Kinova::Api::Base::ServoingModeNotificationList* output)
{
  output->clear_notifications();
  for (int i = 0; i < input.notifications.size(); i++)
  {
...
int ToProtoData(kortex_driver::SequenceInfoNotificationList input,
                Kinova::Api::Base::SequenceInfoNotificationList* output)
{
  output->clear_notifications();
  for (int i = 0; i < input.notifications.size(); i++)
  {
...
int ToProtoData(kortex_driver::ProtectionZoneNotificationList input,
                Kinova::Api::Base::ProtectionZoneNotificationList* output)
{
  output->clear_notifications();
  for (int i = 0; i < input.notifications.size(); i++)
  {
...
int ToProtoData(kortex_driver::CartesianTrajectoryConstraint input,
                Kinova::Api::Base::CartesianTrajectoryConstraint* output)
{
...
int ToProtoData(kortex_driver::PreComputedJointTrajectoryElement input,
                Kinova::Api::Base::PreComputedJointTrajectoryElement* output)
{
  output->clear_joint_angles();
  for (int i = 0; i < input.joint_angles.size(); i++)
  {
...
int ToProtoData(kortex_driver::KinematicTrajectoryConstraints input,
                Kinova::Api::Base::KinematicTrajectoryConstraints* output)
{
